...
namespace Server.Poker
{
    public class PokerPlayer
    {
        ...
        public void CloseAllGumps()//unsure
        {
            CloseGump<PokerTableGump>();
            CloseGump<PokerLeaveGump>();
            CloseGump<PokerJoinGump>();
            CloseGump<PokerBetGump>();
        }


        public void CloseGump<T>() where T : BaseGump
        {
            if (m_Mobile != null)
                m_Mobile.CloseGump<T>();
        }
        ...
        {
            if ( m_Mobile is { NetState: not null } ) return true;
